"""
Django settings for muuch_back project.
...
WSGI_APPLICATION = 'muuch_back.wsgi.application'
...
ADMINS = [
    ('Marco Ponce', 'marco.ponce@rama-ws.com'),
]
...
LOGGING = {
    ...
    'handlers': {
        'mail_admins': {
            ...
            'include_html': True,  # Incluye el error como HTML en el correo electrónico
        },
    },
    'loggers': {
        'django': {
